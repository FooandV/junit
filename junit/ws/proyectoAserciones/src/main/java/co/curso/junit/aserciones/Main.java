...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("validacion de Objetos sin sobreescribir metodo equals() ->" + (personaA==personaB));
...
//		validara si los objetos son iguales si son el mismo objeto en memoria.
		...
		System.out.println("validacion de Objetos implementando metodo equals()  ->" + (personaA.equals(personaB)));
