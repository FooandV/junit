...
public class UtilidadesTest {
	...
	public void testConcatenar() {
		...
		// un Assert es la condición que debe de cumplirse para que un test se considere
		// valido
		...
		// no son iguales
		// se lanzauna excepción y el test falla

		/*
		 * el assertEquals: es un metodo que espera 2 parametros: 1. es lo que que
		 * esperamos o el resultado que esperamos para considerar el test válido, para
		 * el ejemplo el primer parametro debería devolver "Violettateamo" que es un
